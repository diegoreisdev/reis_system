...
<section class="col-md-6 offset-md-3 mt-3">
    <form method="POST" action="<?= site_url('cliente/alterar_cliente/' . $mostra['id']) ?>" class="form-group">
        ...
        <input name="nomeCliente" value="<?= $mostra['nomeCliente'] ?>" type="text" class="form-control form-control-sm nav-item mr-5" autofocus required>

        <label class="m-2">Categoria</label>
        <select name="categoria" value="<?= $mostra['categoria'] ?>" class="form-control" required>
            <option></option>
